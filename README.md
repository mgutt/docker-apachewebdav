## Project
[apachewebdav/apachewebdav](https://github.com/mgutt/docker-apachewebdav) is based on [bytemark/webdav](https://github.com/BytemarkHosting/docker-webdav) (which seems to be dead) which includes different pull requests:
